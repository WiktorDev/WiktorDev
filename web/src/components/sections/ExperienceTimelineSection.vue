...
<template>
  <section id="experience" class="relative py-24 sm:py-32">
    <div class="mx-auto w-full max-w-7xl px-5 sm:px-8">
      <SectionHeading eyebrow="experience" title="Experience built through real products."/>
      ...
      <ol class="relative mt-14 border-l border-border pl-6 sm:pl-10">
        ...
        >
          <span
              aria-hidden="true"
              class="absolute -left-[calc(1.5rem+5px)] top-2 size-2.5 rounded-full border transition-all duration-500 sm:-left-[calc(2.5rem+5px)]"
              :class="[activeIndex === i ? 'scale-125 border-primary bg-primary shadow-[0_0_0_6px_oklch(0.66_0.19_289_/_12%)]' : 'border-border bg-surface-raised'] "
          />

          <div
              class="rounded-2xl border p-6 transition-all duration-500 sm:p-7"
              :class="[activeIndex === i ? 'border-primary/30 bg-surface' : 'border-border bg-surface/40 opacity-70']"
          >
